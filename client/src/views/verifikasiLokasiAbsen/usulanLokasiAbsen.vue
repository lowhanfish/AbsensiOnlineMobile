                ...
                <td class="text-center">
                  <q-btn-group>
                    ...
                    <q-btn @click="mdl_chat = true, selectData(data)" glossy color="light-green-8" icon="chat" class="tbl_btn">
                      <q-tooltip content-class="bg-blue-9" content-style="font-size: 13px">
                        Click untuk melihat Keterangan
                      </q-tooltip>
                    </q-btn>
                    <q-btn @click="mdl_edit = true, selectData(data)" glossy color="orange" icon="create" class="tbl_btn"  :disabled="indicatorColor(data.status).status">
                      <q-tooltip content-class="bg-orange-9" content-style="font-size: 13px">
                        Click untuk mengubah data ini
                      </q-tooltip>
                    </q-btn>
                    <q-btn @click="mdl_hapus = true, selectData(data)" glossy color="negative" icon="delete_forever" class="tbl_btn"  :disabled="indicatorColor(data.status).status">
                        ...
                        <div class="row">
                          <div class="col-12 col-md-12 frame_cari">
                            ...
                            <select v-model="form.jeniskategorilokasi" class="inputbs">
                              <option v-for="data in $store.state.list_MasterKategoriLokasi" :key="data.id" :value="data.id">{{data.uraian}}</option>
                            </select>
                ...
                <q-card class="mdl-md">
                  ...
                  <q-card-section class="q-pt-none">
                      ...
                      <div v-if="form.status == 0">
                        <div class="text-center">
                          <img src="img/process.png" alt="" style="width:100px"> <br>
                          <span class="h_ket" style="color:orange">Usulan masih menunggu proses verifikasi</span> <br>
                        </div>
                      </div>

                      <div v-if="form.status == 1">
                        <div class="text-center">
                          <img src="img/approve.png" alt="" style="width:100px"> <br>
                          <span class="h_ket" style="color:green">data terverifikasi</span> <br>
                          <br>
                          <span class="h_ket_head">Verifikator</span> <br>
                          <span class="h_ket_head">
                            {{UMUM.namaLengkap(form.verifikator_gelar_depan, form.verifikator_nama, form.verifikator_gelar_belakang)}} 
                            <br>
                            ({{UMUM.tglConvert(form.verify_at)}} )
                          </span>
                        </div>
                      </div>  
                      ...
                      <div v-if="form.status == 2">
                        <div class="text-center">
                          <img src="img/alert.png" alt="" style="width:100px"> <br>
                          <span class="h_ket" style="color:#e27171">data dikembalikan</span> <br>
                          <span class="h_ket_head">Ket : {{form.keterangan}}</span> <br>
                          <br>
                          <span class="h_ket_head">Verifikator</span> <br>
                          <span class="h_ket_head">
                            {{UMUM.namaLengkap(form.verifikator_gelar_depan, form.verifikator_nama, form.verifikator_gelar_belakang)}} 
...
export default {
  ...
  methods: {
    ...
    getView : function(){
      ...
      fetch(this.$store.state.url.URL_UsulanLokasi + "view", {
          method: "POST",
          headers: {
    ...
    addData : function(number) {
      ...
      formData.append('jeniskategorilokasi', this.form.jeniskategorilokasi);
      ...
      fetch(this.$store.state.url.URL_UsulanLokasi + "Add", {
          method: "POST",
          headers: {
            // "content-type": "application/json",
            authorization: "kikensbatara " + localStorage.token
    ...
    editData : function(){
      ...
      fetch(this.$store.state.url.URL_UsulanLokasi + "editData", {
          method: "POST",
          headers: {
            authorization: "kikensbatara " + localStorage.token
          },
    ...
    removeData : function(E){
      fetch(this.$store.state.url.URL_UsulanLokasi + "removeData", {
          method: "POST",
          headers: {
            "content-type": "application/json",
            authorization: "kikensbatara " + localStorage.token
